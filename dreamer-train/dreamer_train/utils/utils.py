...
def parse_args():
    ...
    parser.add_argument('--stages', type=str, default='', help='stages of executing task')
    # parser.add_argument('--dist_test', type=bool, default=False, help='distribution for testing')
