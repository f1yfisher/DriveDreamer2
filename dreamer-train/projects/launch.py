...
class DreamerOptions:
    def __init__(self):
        ...
        self.parser.add_argument('--config_name', 
                                ...
                                type=str,
                                default='drivedreamer2_wo_img')
        self.parser.add_argument('--runners', 
                                help='runners is a list, you can specify multiple runners, like [drivedreamer2.DriveDreamer2_Trainer,drivedreamer2.DriveDreamer2_Tester]',
                                type=str,
                                nargs='+',
                                default=['drivedreamer2.DriveDreamer2_Tester'])
    def parse(self):
